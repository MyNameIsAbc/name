...
//				System.out.println("--------------i:"+i+"name:"+name);
	...
	private static void ectractFile(File file, List<Result> results) {
		File fresultfile1 = new File(outFileParentFile2, file.getName().replaceAll(".xls", "") + "1.xls");
		...
		if (number > 0) {
			if (number > 3) {
				...
				File fresultfile2 = new File(outFileParentFile2,
				...
				File fresultfile3 = new File(outFileParentFile2,
